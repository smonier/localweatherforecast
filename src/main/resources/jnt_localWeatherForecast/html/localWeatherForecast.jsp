...
<template:addResources type="css" resources="localWeatherForecast.css"/>
...
<script language='javascript'>
    ...
    localWeatherForecast('${openWeatherMapKey}', '${locationIQApiKey}', '${units}', '${uuid}');
...
<template:addResources type="javascript" insert="body" resources="jquery-3.2.1.min.js, localWeatherForecast.js"/>
