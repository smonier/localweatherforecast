...
public class OpenWeatherMapFilter extends AbstractFilter {
    private static final String OPENWEATHERMAP_KEY_ATTR = "openWeatherMapKey";
    private String openWeatherMapKey;

    @Override
    public String prepare(RenderContext renderContext, Resource resource, RenderChain chain) throws Exception {
        if (StringUtils.isNotEmpty(openWeatherMapKey) && renderContext.getRequest().getAttribute(OPENWEATHERMAP_KEY_ATTR) == null) {
            renderContext.getRequest().setAttribute(OPENWEATHERMAP_KEY_ATTR, openWeatherMapKey);
        }
        return null;
    }
